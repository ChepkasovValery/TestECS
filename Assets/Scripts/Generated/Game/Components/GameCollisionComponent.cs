...
public partial class GameEntity {
    ...
    public void AddCollision(GameEntity newFirstEntity, GameEntity newSecondEntity) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.FirstEntity = newFirstEntity;
        component.SecondEntity = newSecondEntity;
        AddComponent(index, component);
    }

    public void ReplaceCollision(GameEntity newFirstEntity, GameEntity newSecondEntity) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.FirstEntity = newFirstEntity;
        component.SecondEntity = newSecondEntity;
